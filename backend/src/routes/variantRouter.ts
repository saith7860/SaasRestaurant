...
variantRouter.patch("/update-variant/:id",authMiddleware,checkAdmin,validate(variantSchema),variantController.updateSpecificVariant) //UPDATE SPECIFIC VARIANT
