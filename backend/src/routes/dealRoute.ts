...
dealRouter.put("/update-deal/:id",authMiddleware,checkAdmin,uploadSingleImage,validate(createDealSchema),validateImage,parseItemDeals,dealController.updateSpecificDeal) //UPDATE SPECIFIC DEAL
