...
const SearchBar: FC<SearchBarProps> = ({search, setSearch }) => {
  return (
    <div className="flex items-center w-full justify-between">
        {/* Desktop Search Bar */}
        <div className="flex items-center w-[70%] justify-right bg-[var(--card-color)] border border-[var(--primary-color)]/20 rounded-xl px-3 py-2 m-2 focus-within:border-[var(--primary-color)] focus-within:ring-2 focus-within:ring-[var(--primary-color)]/20 transition-all">
