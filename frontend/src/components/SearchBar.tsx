...
const SearchBar: FC<SearchBarProps> = ({ search, setSearch }) => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 my-5 mb-10 mx-2 md:mx-4">
      {/* Desktop Search Bar */}
      <div className="flex items-center w-full justify-right bg-[var(--card-color)] border border-[var(--primary-color)]/20 rounded-xl px-3 py-2 m-2 focus-within:border-[var(--primary-color)] focus-within:ring-2 focus-within:ring-[var(--primary-color)]/20 transition-all">
