...
const SearchBar: FC<SearchBarProps> = ({ search, setSearch }) => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-content gap-4 md:gap-8 my-5 mx-2 md:mx-4">
      {/* Desktop Search Bar */}
      ...
      <div>
        ...
        <p className="text-sm line-clamp-1 text-[var(--text-color)]/70">
