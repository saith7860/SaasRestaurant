...
const AddToCart = ({
  ...
  const handleAddToCart = (
    ...
    // Check whether this exact item/variant is already in cart
      ...
      const updatedCart = cart.map((cartItem) =>
        ...
        (
          ...
          ? {
              ...
              // Keep image available in case old cart data
              // did not have it.
    ...
    const newItem: CartItem = {
      ...
      // IMPORTANT:
      // API returns image as { url, publicId }
      // CartItem expects image as a string.
      image: item.image?.url,
